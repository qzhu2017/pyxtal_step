...
class PyXtalStep(object):
    ...
    my_description["description"] : tuple
        A description of the PyXtal step. It must be
    ...
    def description(self):
        ...
        return PyXtalStep.my_description
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return pyxtal_step.PyXtal(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return pyxtal_step.TkPyXtal(canvas=canvas, **kwargs)
